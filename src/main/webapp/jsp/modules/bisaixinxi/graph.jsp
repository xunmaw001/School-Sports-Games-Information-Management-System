...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">比赛信息统计</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>比赛信息统计</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/bisaixinxi/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/bisaixinxi/"+colName,
			data:{	tableName: "bisaixinxi",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
