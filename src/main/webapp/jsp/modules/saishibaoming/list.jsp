...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">赛事报名管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>赛事报名列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">赛事报名列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										比赛项目
									</label>
									<input type="text" id="bisaixiangmuSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('baomingshijian')">报名时间<i id="baomingshijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('baomingfangshi')">报名方式<i id="baomingfangshiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#bisaixiangmuSearch').val() != null && $('#bisaixiangmuSearch').val() != ''){
				searchForm.bisaixiangmu ="%" +  $('#bisaixiangmuSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var baomingshijianCell  = document.createElement('td');

						  baomingshijianCell.innerHTML = item.baomingshijian;


			row.appendChild(baomingshijianCell);
			var baomingfangshiCell  = document.createElement('td');

						  baomingfangshiCell.innerHTML = item.baomingfangshi; 

			row.appendChild(baomingfangshiCell);
		...
		function sh(){
			...
			httpJson("saishibaoming/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("saishibaoming/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"saishibaoming");
