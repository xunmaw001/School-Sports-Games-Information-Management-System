						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="baomingshijian" name="baomingshijian" class="form-control" v-model="ruleForm.baomingshijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>报名方式</label>

									<input id="baomingfangshi" name="baomingfangshi" class="form-control" v-model="ruleForm.baomingfangshi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
