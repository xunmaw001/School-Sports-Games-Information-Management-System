						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="bisaishijian" name="bisaishijian" class="form-control" v-model="ruleForm.bisaishijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>比赛地点</label>
									...
									<input id="bisairenshu" name="bisairenshu" class="form-control" v-model="ruleForm.bisairenshu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>图片</label>
