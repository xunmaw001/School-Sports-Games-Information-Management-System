...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>裁判管理</span></li>
								<li class="breadcrumb-item active"><span>裁判列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">裁判列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										裁判账号
									</label>
									<input type="text" id="caipanzhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#caipanzhanghaoSearch').val() != null && $('#caipanzhanghaoSearch').val() != ''){
				searchForm.caipanzhanghao ="%" +  $('#caipanzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("caipan/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				caipanzhanghao : searchForm.caipanzhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("caipan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"caipan");
