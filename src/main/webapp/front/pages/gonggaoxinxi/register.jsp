            ...
            <article>
                ...
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="bisaididian" name="bisaididian" placeholder="请输入比赛地点" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="bisairenshu" name="bisairenshu" placeholder="请输入比赛人数" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="zhuyishixiang" name="zhuyishixiang" placeholder="请输入注意事项" autocomplete="off" class="layui-input">
                  </div>
                </div>
      ...
      form.on('submit(register)', function(data) {
        data = data.field;
          ...
          return false
                                        ...
                                        if(!isIntNumer(data.bisairenshu)){
          layer.msg('比赛人数应输入整数', {
            time: 2000,
            icon: 5
          });
