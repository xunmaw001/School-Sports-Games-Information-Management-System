					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="bisaixiangmu" id="bisaixiangmu">
							...
							<div class="layui-input-block">
								<input type="text" name="xingming" id="xingming" placeholder="姓名" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">犯规次数</label>
							<div class="layui-input-block">
								<input type="text" name="fanguicishu" id="fanguicishu" placeholder="犯规次数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">犯规内容</label>
							<div class="layui-input-block">
								<input type="text" name="fanguineirong" id="fanguineirong" placeholder="犯规内容" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="riqi" id="riqi" placeholder="日期" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">裁判账号</label>
							<div class="layui-input-block">
								<input type="text" name="caipanzhanghao" id="caipanzhanghao" placeholder="裁判账号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">裁判姓名</label>
							<div class="layui-input-block">
								<input type="text" name="caipanxingming" id="caipanxingming" placeholder="裁判姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                								...
                								http.request(`option/bisaixinxi/bisaixiangmu`,'get',{},(res)=>{
