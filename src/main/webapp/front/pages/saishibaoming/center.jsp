					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="bisaixiangmu" id="bisaixiangmu" placeholder="比赛项目" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">比赛日期</label>
							<div class="layui-input-block">
								<input type="text" name="bisairiqi" id="bisairiqi" placeholder="比赛日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">比赛地点</label>
							<div class="layui-input-block">
								<input type="text" name="bisaididian" id="bisaididian" placeholder="比赛地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">报名时间</label>
							<div class="layui-input-block">
								<input type="text" name="baomingshijian" id="baomingshijian" placeholder="报名时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">报名方式</label>
							<div class="layui-input-block">
								<select name="baomingfangshi" id="baomingfangshi">
									<option value="">请选择</option>
									<option v-for="(item,index) in baomingfangshi" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																								...
                																																								vue.baomingfangshi = '线上报名,现场报名'.split(',')
