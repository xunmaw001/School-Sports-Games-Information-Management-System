			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.bisaixiangmu" type="text" name="bisaixiangmu" id="bisaixiangmu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">比赛日期：</label>
						<div class="layui-input-block">
							<input v-model="detail.bisairiqi" type="text" name="bisairiqi" id="bisairiqi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="baomingfangshi" id="baomingfangshi" lay-filter="baomingfangshi">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('saishibaoming' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
